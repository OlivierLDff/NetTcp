...
{
    connect(_worker.get(), &ServerWorker::newIncomingConnection, this, [this](qintptr handle) {
        if(!handle)
        {
        ...
        connect(socket, &Socket::startFailed, this, [this, socket]() {
            LOG_ERR("Client Start fail : disconnect");
            disconnect(socket, nullptr, this, nullptr);
            socket->deleteLater();
        });
        connect(socket, &Socket::startSuccess, this, [this, socket](const QString& address, const quint16 port) {
    ...
    connect(_worker.get(), &ServerWorker::acceptError, this, [this](int error) {
