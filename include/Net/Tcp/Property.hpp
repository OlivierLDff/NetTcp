...
protected:                                                                     \
    Q_PROPERTY(type attribute READ attribute WRITE set##Attribute RESET        \
            reset##Attribute NOTIFY attribute##Changed)
...
#define NETTCP_ABSTRACT_PROPERTY(type, attribute, Attribute)                   \
    NETTCP_ABSTRACT_PROPERTY_D(type, attribute, Attribute, {})
...
#define NETTCP_IMPL_PROPERTY(type, attribute, Attribute)                       \
    NETTCP_IMPL_PROPERTY_D(type, attribute, Attribute, {})
...
#define NETTCP_PROPERTY(type, attribute, Attribute)                            \
    NETTCP_PROPERTY_D(type, attribute, Attribute, {})

#define NETTCP_PROPERTY_RO_D(type, attribute, Attribute, def)                  \
    _NETTCP_Q_PROPERTY_RO(type, attribute, Attribute)                          \
    _NETTCP_PROPERTY_SHARED(type, attribute, Attribute, def)

#define NETTCP_PROPERTY_RO(type, attribute, Attribute)                         \
    NETTCP_PROPERTY_RO_D(type, attribute, Attribute, {})
...
#define NETTCP_PROPERTY_CONST(type, attribute, Attribute)                      \
    NETTCP_PROPERTY_CONST_D(type, attribute, Attribute, {})

#define NETTCP_ATTRIBUTE_D(type, attribute, Attribute, def)                    \
    _NETTCP_ATTRIBUTE_SHARED(type, attribute, Attribute, def)

#define NETTCP_ATTRIBUTE(type, attribute, Attribute)                           \
    NETTCP_ATTRIBUTE_D(type, attribute, Attribute, {})

#define NETTCP_REGISTER_TO_QML(Type)                                           \
public:                                                                        \
    static void registerToQml(const char* uri, const int majorVersion,         \
        const int minorVersion, const char* name = #Type)                      \
    {                                                                          \
...
public:                                                                        \
    ...
    static void registerSingleton(const char* uri, const int majorVersion,     \
        const int minorVersion, const char* n = #Class)                        \
    {                                                                          \
        qmlRegisterSingletonType<Class>(                                       \
            uri, majorVersion, minorVersion, n, &Class::set##Name);            \
    }
